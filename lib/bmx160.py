...
class BMX160:
    ...
    def gyro(self):
        ...
        try:
            ...
            print(self.GYR_SCALAR)
            print(self._gyro)
            print(tuple(x * self.GYR_SCALAR for x in self._gyro))
            raise(e)
    ...
    def accel(self):
        ...
        try:
            ...
            print('FATAL ERROR: {}'.format(e))
            print(self.ACC_SCALAR)
            print(self._accel)
            print(tuple(x * self.ACC_SCALAR for x in self._accel))
            raise(e)
    ...
    def mag(self):
        ...
        try:
            ...
            print('FATAL ERROR: {}'.format(e))
            print(self.MAG_SCALAR)
            print(self._mag)
            print(tuple(x * self.MAG_SCALAR for x in self._mag))
            raise(e)
