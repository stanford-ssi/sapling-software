...
class task(Task):
    ...
    cmd_dispatch = {
        ...
        'send_file':    cdh.send_file,
        # 'arm':          cdh.arm,
        # 'disarm':       cdh.disarm,
        # 'deploy':       cdh.deploy
    }
    sapling = b''
